...
const SearchBar = () => {
  ...
  const getAllSubCategories = async () => {
    try {
      const data = await axios.get(`${backendUrl}:${backendPort}/categories/`);
  ...
  const getAllProducts = async (subcat) => {
    try {
      const data = await axios.get(`${backendUrl}:${backendPort}/products/`);
  ...
  const fetchData = async (query) => {
    try {
      const response = await axios.get(
        `${backendUrl}:${backendPort}/products/?search=${query}`
      );
